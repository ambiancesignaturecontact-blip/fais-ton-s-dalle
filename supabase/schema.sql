-- =============================================================
-- SUPABASE SETUP — FAIS TON S'DALLE
-- Execute cette requête dans Supabase SQL Editor
-- =============================================================
...
-- Permettre l'insertion anonyme (via API avec service_role)
CREATE POLICY "Allow insert orders anon" ON orders
  FOR INSERT WITH CHECK (true);

CREATE POLICY "Allow insert order_items anon" ON order_items
  FOR INSERT WITH CHECK (true);

CREATE POLICY "Allow insert newsletter anon" ON newsletter_subscribers
  FOR INSERT WITH CHECK (true);

-- Lecture réservée aux authentifiés (admin)
CREATE POLICY "Allow select orders auth" ON orders
  FOR SELECT USING (auth.role() = 'service_role');

-- =============================================================
-- SEED DATA — MENU A JOUR
-- =============================================================
