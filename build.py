#!/usr/bin/env python3
"""Build index.html - clean version"""
import base64, io, os
...
<link rel="apple-touch-icon" href="data:image/png;base64,""" + FAV + """">
...
<body>
<div class="bar"><span>☀️ 11h30–23h</span><span class="n">🌙 Livraison 23h–06h</span><span>⭐ 4.4 · 93320</span></div>
<header><div class="hd"><a href="#" class="lg"><img src="" alt="FAIS TON S'DALLE" id="logo"><div>FAIS TON S'DALLE<s>Sandwichs sur mesure</s></div></a><nav class="nv"><a class="sl" onclick="gp('acc')">Accueil</a><a onclick="gp('menu')">Menu</a><a onclick="gp('ap')">Infos</a><a onclick="gp('con')">Contact</a><button class="tg" onclick="tt()" id="tt">🌙</button><div class="ct" onclick="tc()">🛒<span class="cb" id="cc">0</span></div></nav></div></header>
<div class="nb" id="nb">🌙 Livraison 23h–06h – <a href="https://www.ubereats.com/fr-en/store/fais-ton-sdalle/qQkk53_5XNaUCkcZTskV6g" target="_blank" style="color:#c7d2fe;text-decoration:underline">Uber Eats</a></div>

<div class="pg" id="acc">
<section class="hero"><div><h1>Crée ton <span class="h">sandwich</span> sur mesure</h1><p class="t">🥩 Viandes froides · 🥗 Crudités fraîches · 🧂 Sauces</p><div class="s"><span><strong>⭐ 4.4</strong> 14 avis</span><span><strong>📍</strong> Les Pavillons-sous-Bois</span><span><strong>🌙</strong> Livraison 6h</span><span><strong>🚚</strong> Uber Eats</span></div></div></section>
...
<div class="tb"><button class="on" data-c="all">🔥 Tout</button><button data-c="menus">🥪 Sandwichs</button><button data-c="desserts">🍰 Desserts</button><button data-c="boissons">🥤 Boissons</button></div>
...
<div style="text-align:center;margin:24px 0"><a href="https://www.ubereats.com/fr-en/store/fais-ton-sdalle/qQkk53_5XNaUCkcZTskV6g" target="_blank" class="ub2">🛵 Commander sur Uber Eats</a></div></div></div>
...
<div class="cd"><h3>Horaires 7j/7</h3><p>☀️ Service : <strong>11h30–23h00</strong></p><p>🌙 Livraison : <strong>23h00–06h00</strong></p></div>
<div class="cd"><h3>Coordonnées</h3><p>134 Allée du Colonel Fabien, 93320</p><p>📞 <a href="tel:+33672044875" class="btl">06 72 04 48 75</a></p>
<p><a href="https://maps.google.com/maps?q=FAIS+TON+S%E2%80%99DALLE+134+All%C3%A9e+du+Colonel+Fabien+93320" target="_blank" style="color:var(--p);font-weight:600">📍 Google Maps</a></p>
<p><a href="https://www.ubereats.com/fr-en/store/fais-ton-sdalle/qQkk53_5XNaUCkcZTskV6g" target="_blank" class="ub" style="margin-top:6px">🛵 Uber Eats</a></p></div>
...
<rect width="130" height="130" fill="none"/><g fill="var(--t)" opacity=".85">
<rect x="10" y="10" width="26" height="26" rx="3"/><rect x="94" y="10" width="26" height="26" rx="3"/><rect x="10" y="94" width="26" height="26" rx="3"/><rect x="52" y="10" width="26" height="26" rx="3"/><rect x="40" y="42" width="13" height="13"/><rect x="77" y="42" width="13" height="13"/><rect x="64" y="66" width="13" height="13"/><rect x="40" y="78" width="13" height="13"/><rect x="94" y="54" width="13" height="13"/><rect x="90" y="94" width="26" height="26" rx="3"/><rect x="64" y="94" width="13" height="13"/><rect x="40" y="94" width="13" height="13"/><rect x="10" y="42" width="26" height="13"/><rect x="10" y="66" width="13" height="13"/><rect x="24" y="78" width="13" height="13"/><rect x="70" y="54" width="7" height="7"/><rect x="52" y="54" width="7" height="7"/><rect x="84" y="72" width="7" height="7"/><rect x="103" y="78" width="13" height="13"/><rect x="52" y="84" width="7" height="7"/><rect x="46" y="62" width="7" height="7"/></g>
...
<div class="inf"><div><div class="ic">📍</div><h4>Adresse</h4><p>134 Allée du Colonel Fabien<br>93320 Les Pavillons-sous-Bois</p><a href="https://maps.google.com/maps?q=FAIS+TON+S%E2%80%99DALLE+134+All%C3%A9e+du+Colonel+Fabien+93320" target="_blank" style="color:var(--p);font-weight:600;font-size:.68rem">Google Maps →</a></div>
<div><div class="ic">🕐</div><h4>Horaires 7j/7</h4><div class="hg"><div><span>☀️ Service</span><span>11h30–23h</span></div><div class="nt"><span>🌙 Livraison</span><span>23h–06h</span></div></div><span class="hb">7j/7</span></div>
<div><div class="ic">📞</div><h4>Téléphone</h4><p><a href="tel:+33672044875" class="btl">06 72 04 48 75</a></p><p style="font-size:.65rem;color:var(--t2)">Appel ou SMS</p></div>
<div><div class="ic">🚚</div><h4>Commander</h4><p>Uber Eats · Téléphone</p><a href="https://www.ubereats.com/fr-en/store/fais-ton-sdalle/qQkk53_5XNaUCkcZTskV6g" target="_blank" class="ub" style="margin-top:6px">🛵 Uber Eats</a></div></div>
<div style="display:flex;gap:12px;justify-content:center;margin:16px 0;flex-wrap:wrap">
<a href="https://wa.me/33672044875" target="_blank" class="ub" style="background:#25D366">📱 Commander par WhatsApp</a>
<a href="javascript:void(0)" onclick="shareMenu()" class="ub" style="background:#666">📤 Partager le menu</a>
</div>
...
<div><h4>Contact</h4><p>📞 <a href="tel:+33672044875">06 72 04 48 75</a></p><p>📍 134 Allée du Colonel Fabien, 93320</p><p>☀️ 11h30–23h · 🌙 23h–06h</p></div>
<div><h4>Suivez-nous</h4><a href="https://www.tiktok.com/@faistonsdalle" target="_blank">🎵 TikTok</a><a href="https://www.ubereats.com/fr-en/store/fais-ton-sdalle/qQkk53_5XNaUCkcZTskV6g" target="_blank">🛵 Uber Eats</a></div></div>
<div class="fb">© 2026 FAIS TON S'DALLE – Les Pavillons-sous-Bois 93320</div></footer>

<script>
var I={l:"LOGO_PLACEHOLDER",a:"A_PLACEHOLDER",b:"B_PLACEHOLDER",c:"C_PLACEHOLDER",d:"D_PLACEHOLDER",e:"E_PLACEHOLDER",f:"F_PLACEHOLDER",g:"G_PLACEHOLDER",h:"H_PLACEHOLDER",i:"I_PLACEHOLDER"};
...
function om(id){var i=M.find(function(x){return x.id===id});if(!i||!i.cs)return;ci=i;cs={};document.getElementById('mt').textContent='🥪 '+i.n;document.getElementById('mb').innerHTML='<div class=\"cs\"><h4>🥩 Viande</h4><div class=\"og\">'+['Jambon blanc','Jambon fumé','Poulet rôti','Dinde','Salami','Pastrami','Rosbif','Thon'].map(function(v){return '<button onclick=\"sel(\'v\',\''+v+'\',this)\">'+v+'</button>'}).join('')+'</div></div><div class=\"cs\"><h4>🥗 Crudités (plusieurs)</h4><div class=\"og\">'+['Salade','Tomates','Concombre','Oignons','Poivrons','Maïs','Carottes','Cornichons'].map(function(v){return '<button onclick=\"sel(\'r\',\''+v+'\',this)\">'+v+'</button>'}).join('')+'</div></div><div class=\"cs\"><h4>🧂 Sauce</h4><div class=\"og\">'+['Mayo','Ketchup','Moutarde','Blanche','Algérienne','Andalouse','Samouraï','Huile olive'].map(function(v){return '<button onclick=\"sel(\'s\',\''+v+'\',this)\">'+v+'</button>'}).join('')+'</div></div>';document.getElementById('mp').textContent=i.p.toFixed(2)+'€';document.getElementById('mod').classList.add('on');document.body.style.overflow='hidden'}
...
function shareMenu(){if(navigator.share){navigator.share({title:"FAIS TON S'DALLE",text:"🥪 Crée ton sandwich sur mesure ! Livraison jusqu'à 6h !",url:"https://faistonsdalle.fr"}).catch(function(){})}else{prompt("Copie ce lien :","https://faistonsdalle.fr")}}
uc();
...
# Now do replacements
html = TEMPLATE.replace('LOGO_PLACEHOLDER', LOGO)
for k, v in IMGS.items():
    html = html.replace(f'{k.upper()}_PLACEHOLDER', v)
